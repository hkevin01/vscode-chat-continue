...
class AutomationLogger:
    ...
    def log_operation_success(self, operation: str, 
    ...
    def log_operation_failure(self, operation: str, error: str, 
        ...
        if operation_id and self.config.get("detailed_timing", False):
            self._update_performance_metric(operation_id, "failure", 
                                          {"error": error})
    ...
    def log_fallback_used(self, fallback_type: str, 
                         details: Optional[Dict[str, Any]] = None):
    ...
    def _update_performance_metric(self, operation_id: str, status: str, 
                                 result: Optional[Dict[str, Any]] = None):
