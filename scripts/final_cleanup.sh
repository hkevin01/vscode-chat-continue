...
echo "🚀 To start GUI: DISPLAY=:0 python src/gui/main_window.py"
echo "⚙️  To start CLI: DISPLAY=:0 python src/main.py --dry-run"
echo ""
echo "💡 Note: If window detection fails, ensure DISPLAY=:0 is set"
echo "    Example: DISPLAY=:0 python src/main.py --dry-run"