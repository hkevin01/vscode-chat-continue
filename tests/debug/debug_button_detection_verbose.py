...
def setup_debug_logging():
    ...
    logging.basicConfig(
        ...
        handlers=[
            ...
            logging.FileHandler('/tmp/button_debug.log')
        ]
    )
                ...
                for config in configs:
                    ...
                    try:
                        ...
                        for k in range(len(ocr_data['text'])):
                            ...
                            if text and conf > 10:
                                logger.info(f"  OCR: '{text}' (conf: {conf}) at "
            ...
            for y in range(height // 4, height * 3 // 4, 20):
                for x in range(right_third, width - 10, 20):
                    try:
                        ...
                        if (pixel[2] > pixel[0] and pixel[2] > pixel[1] and 
                            pixel[2] > 100):  # More blue than red/green
