...
class TestPhase1Foundation(unittest.TestCase):
    ...
    def test_project_setup_and_structure(self):
        ...
        essential_dirs = ["src/core", "src/utils", "tests/unit", "docs", "config", "scripts"]
        ...
        for file_path in essential_files:
            self.assertTrue(Path(file_path).exists(), f"File {file_path} should exist")
...
class TestPhase2CoreFeatures(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.test_config = {
            ...
            "automation": {"dry_run": True, "click_delay_ms": 100},
            "logging": {"level": "DEBUG", "console_output": False},
        }
    ...
    def test_continue_button_detection_template(self, mock_match):
        ...
        with patch("cv2.imread", return_value=template):
            buttons = finder.find_continue_buttons_template(
                self.test_image, "templates/continue_button.png"
            )
    ...
    def test_multi_window_support(self, mock_find_buttons, mock_get_windows):
        ...
        mock_windows = [
            ...
            },
            {
                "id": 456,
                "title": "VS Code 2",
                "geometry": {"x": 800, "y": 0, "width": 800, "height": 600},
            },
        ]
        mock_get_windows.return_value = mock_windows

        # Mock button detection
        mock_find_buttons.return_value = [{"center_x": 400, "center_y": 300, "confidence": 0.9}]
...
class TestPhase3Enhancement(unittest.TestCase):
    ...
    def test_performance_optimization(self, mock_time):
        ...
        logger = AutomationLogger(
            {"detailed_timing": True, "log_performance": True, "console_output": False}
        )
    ...
    def test_safety_features(self, mock_press):
        ...
        config_with_safety = {
            **self.test_config,
            "safety": {"safe_mode": True, "emergency_stop_key": "escape", "preserve_focus": True},
        }
...
class TestPhase4Polish(unittest.TestCase):
    ...
    def test_testing_coverage(self):
        ...
        test_files = ["tests/test_phases.py", "tests/unit/test_config_manager.py"]  # This file

        for test_file in test_files:
            self.assertTrue(Path(test_file).exists(), f"Test file {test_file} should exist")
    ...
    def test_requirements_and_dependencies(self):
        ...
        essential_deps = ["pyautogui", "opencv-python", "pytesseract", "psutil", "pynput"]

        for dep in essential_deps:
            self.assertIn(
                dep, requirements_content, f"Dependency {dep} should be in requirements.txt"
            )
...
class TestIntegration(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.test_config = {
            ...
            "safety": {"safe_mode": True, "preserve_focus": True},
            "logging": {"level": "INFO", "console_output": False},
        }
