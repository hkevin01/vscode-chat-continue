...
class UnfocusedWindowTester:
    ...
    async def test_detect_unfocused_windows(self) -> bool:
        ...
        for i, window in enumerate(windows):
            ...
            if image:
                ...
                buttons = self.engine.button_finder.find_continue_buttons(
    ...
    async def test_focus_management(self) -> bool:
        ...
        print(f"  📊 Focus success rate: {success_count}/{len(windows)} "
    ...
    async def test_click_unfocused_button(self) -> bool:
        ...
        for window in windows:
            ...
            if buttons:
                ...
                print(f"      🎯 Attempting to click button at "
                      f"({best_button.x}, {best_button.y})")
    ...
    async def test_background_automation(self) -> bool:
        ...
        cycles_run = final_stats.get('cycles_completed', 0) - initial_stats.get('cycles_completed', 0)
        windows_processed = final_stats.get('windows_processed', 0) - initial_stats.get('windows_processed', 0)
    ...
    def _open_test_browser(self):
        ...
        try:
            ...
            if os.path.exists(test_file):
                subprocess.Popen(['xdg-open', f'file://{test_file}'], 
